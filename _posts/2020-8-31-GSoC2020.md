...
and output the logged events into a .pb file, which was named Threemon. Threemon is based on [Google’s protocol buffer language](https://developers.google.com/protocol-buffers/docs/overview), which makes it possible to stream events directly from file. Cuckoo added the support of a similar file structure a while ago which was named [Onemon](https://hatching.io/blog/onemon-cuckoo-release/). 
